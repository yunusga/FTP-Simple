...
var context;
module.exports = o;
o.setContext = function(con){
  context = con;
};
o.getOldConfigPath = function(filename){
...
o.isChangeTextDocument = function(uri){
  var arr = o.getActiveFilePathAll();
...
o.getWorkspaceConfig = o.getConfiguration = function(key){
  var arr = key.split(".");
